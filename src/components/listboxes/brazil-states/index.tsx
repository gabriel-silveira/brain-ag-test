...
interface BrazilStatesListBoxProps {
  value: string,
  onChange: (value: string) => void,
}

function BrazilStatesListBox(props: BrazilStatesListBoxProps) {
  ...
  useEffect(() => {
    const stateFound = states.find((state) => state.name === value);

    if (stateFound) {
      setSelected(() => (stateFound));
    }
  }, [value]);
